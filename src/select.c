...
bool is_selecting(void) { return selecting; }

void cancel_selection(void) { selecting = false; }

Point get_selection_start(void) { return selection_start; }

Point get_selection_end(void) { return selection_end; }
